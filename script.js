...
const students = [
    ...
    { roll: 30, name: "Ishwarya" }, { roll: 31, name: "Kajitha" }, { roll: 32, name: "Kanisha" },
    ...
    { roll: 39, name: "Latika Shalin" }, { roll: 40, name: "Linga Arasi" }, { roll: 41, name: "Madhumitha" },
...
const colors = [
    ...
    "#D6BAFF","#FFBAE1","#BAF0FF","#D6FFBA","#FFF3BA"
];
